	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<p>Select your entrees from the menu below. To calculate the amount of the bill, click the Calculate Bill button. Check the "Highlight onsale" box to highlight onsale.</p>
				<table id="menuTable" border="1" class="indent">
					<thead>
						<tr>
							<th colspan="3">Sale Store</th>
						</tr>
						<tr>
							<th>Select</th>
							<th>Item</th>
                ...
                Total: €
                <input type="text" name="txtBillAmt"/><input type="checkbox" name="cbOpts" value="isVeg" id="showVeg"/><label for="showVeg">Highlight onsale</label></p>
				</form>
			</body>
		</html>
	</xsl:template>
