	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<p>Select your entrees from the menu below. To calculate the amount of the bill, click the Calculate Bill button. Check the "Highlight onsale" box to highlight onsale things.</p>
